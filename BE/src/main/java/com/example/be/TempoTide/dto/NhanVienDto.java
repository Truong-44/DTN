...
public class NhanVienDto {
    ...
    @Schema(description = "Creation date of the employee record", example = "2023-01-01T10:00:00")
    private LocalDateTime ngayTao;

    @NotNull(message = "NgayCapNhat is required")
    @Schema(description = "Last update date of the employee record", example = "2023-01-02T10:00:00")
